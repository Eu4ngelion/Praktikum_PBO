    ...
    public static void kelolaKamar() {
        ...
        if (daftarKamar.isEmpty()) {
            ...
            for (Kamar kamar : daftarKamar) {
                System.out.println("ID : " + kamar.getId() + ", Nomor: " + kamar.getNomor() + ", Harga: " + kamar.getHarga() + ", Status: " + (kamar.isDihuni() ? "Dihuni" : "Kosong"));
            }
        }
        System.out.println("==========================");
        ...
        switch (pilihan) { 
            case 1: // Lihat Kamar
                ...
                found = false;
                for (Kamar kamar : daftarKamar) {
                    if(kamar.getId() == Integer.parseInt(idKamar)) {
            ...
            case 3: // Edit Kamar
                ...
                // Detail Lama
                for (Kamar kamar : daftarKamar) {
                    if (kamar.getId() == Integer.parseInt(editIdKamar)) {
                        System.out.println("------ DETAIL KAMAR ------");   
                        kamar.infoKamar(daftarUser);
                        found = true;
                    }
                ...
                for (Kamar kamar : daftarKamar) {
                    if (kamar.getNomor().equals(newNomorKamar) && kamar.getId() != Integer.parseInt(editIdKamar)) {
                ...
                for (User penghuni : daftarUser) {
                    if (penghuni instanceof Penghuni && ((Penghuni) penghuni).getId() == Integer.parseInt(editIdKamar) && ((Penghuni) penghuni).getIsHuni()) {
            ...
            case 4: // Hapus Kamar
                ...
                found = false;
                for (Kamar kamar : daftarKamar) {
                    if (kamar.getId() == Integer.parseInt(hapusIdKamar)) {
                        // Ganti Id Kamar 
                        for (User penghuni : daftarUser) {
                            if (penghuni instanceof Penghuni && ((Penghuni) penghuni).getId() == Integer.parseInt(hapusIdKamar) && ((Penghuni) penghuni).getIsHuni()) {
    ...
    public static void kelolaPenghuni() {
        ...
        switch (pilihan){
            ...
            case 2: // Edit Penghuni
                ...
                // Update Kamar
                for (Kamar kamar : daftarKamar) {
                    if (kamar.getId() == Integer.parseInt(editIdPenghuni)) {
            ...
            case 3: // Hapus Penghuni
                ...
                for (User penghuni : daftarUser) {
                    if (penghuni.getId() == Integer.parseInt(hapusIdPenghuni)) {
                        for (Kamar kamar : daftarKamar) {
                            if (kamar.getId() == ((Penghuni) penghuni).getId()) {
